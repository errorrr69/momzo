...
///
/// Home · Learn · Ask · Play · Circle. "Me" is deliberately not here: settings
...
/// games and the Circle got promoted into daily reach without adding a sixth
/// tab nobody could parse.
...
class _MainShellState extends State<MainShell> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // child (Task 23). Circle is account-level, so it stays stable.
